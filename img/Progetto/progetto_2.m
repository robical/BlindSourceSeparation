...
rit1=4;
rit2=3;        %prima erano 160,560,800...provo per vedere...!!!
...
mic1=signal1r+signal2+signal3;
%creo il segnale totale al secondo microfono
mic2=signal1+signal2r+signal3r;
...
for a=1:size(fasi,2)/2;
    fasi(:,a)=fasi(:,a)./Norm(a,1);
end;
...
%fasi
den=(0.0029*0.4);   %1/c^(-1)*d    c=velocità prop.  d=distanza microfoni
fasi=fasi/den;
