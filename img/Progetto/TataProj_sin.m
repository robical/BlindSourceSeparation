...
% 
% 
% UTILIZZO TRE SEGNALI MOLTO SEMPLICI, TRE SINUSOIDI A FREQ DIVERSE, PER
% CAPIRE IL FUNZIONAMENTO CORRETTTO O MENO DELLA PROCEDURA DI
% CLASSIFICAZIONE
...
Lenght=16000;  %lunghezza in campioni del segnale
win=hamming(512);   %finestra
...
signal1=sin(2*pi*150*t);
signal2=sin(2*pi*50*t);
signal3=sin(2*pi*400*t);
...
for i=1:60;  %prima era cicli invece che 93!!!
